...
@testset "Formulas de convección" begin
    @test h_conv(5.6,Wall(1.2),Gas("air",310),310,290) ≈ 8.44 atol=0.01
    @test h_conv(12,Wall(1.2),Gas("air",300),300,350) ≈ 21.88 atol=0.01
    @test h_conv(2,Wall(1.65),Liquid("agua",300),300,350) ≈ 5360 atol = 50
