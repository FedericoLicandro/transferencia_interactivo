...
νₗ["air",100] = 2.000*10^-6; νₗ["air",150] = 4.426*10^-6; νₗ["air",200]  = 7.590*10^-6; νₗ["air",250] = 11.44*10^-6; νₗ["air",300] = 15.89*10^-6; νₗ["air",350] = 20.29*10^-6; νₗ["air",400] = 26.41*10^-6; νₗ["air",450] = 32.39*10^-6;
...
νₗ["agua",273.15] = 1.000*175.0*10^-8; νₗ["agua",280] = 1.000*142.2*10^-8; νₗ["agua",290]     = 1.001*108.0*10^-8; νₗ["agua",300] = 1.003*855*10^-9; νₗ["agua",310] = 1.007*695*10^-9; νₗ["agua",320] = 1.011*577*10^-6; νₗ["agua",330] = 1.018*489*10^-9; νₗ["agua",340] = 1.021*420*10^-9;
